...
<div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-4 text-center mb-4 mb-md-0">
                <div class="imagen-servicio">
                    ...
                    <div class="row no-gutters servicio-info">
                        <div class="col-8 offset-2 col-md-10 offset-md-1 encabezado pt-4">
    ...
    <section class="productos container py-5">
        <h2 class="encabezado text-center text-uppercase mt-4"><span class="text-lowercase d-block">nuestros</span> productos</h2>
        <div class="row py-5">
            <?php echo do_shortcode('[carolinaspa_productos numero=4]') ?>
        </div><!--.row-->
        <a href="<?php echo get_permalink(19); ?>" class="btn btn-success float-right tienda">Ver mas</a>
    </section>
